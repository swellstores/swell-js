...
},{"lodash.camelcase":5,"lodash.snakecase":6}],8:[function(require,module,exports){
'use strict';
...
},{"./card":15,"./utils":16,"buffer":2,"isomorphic-fetch":4}],15:[function(require,module,exports){
const {
  trimStart,
  trimEnd,
  toCamel
...
const api = {
  ...
  expiry(value) {
    ...
    const month = parts[0];
    const year = parts[1]; // Convert 2 digit year
...
const {
  normalizeKeys
} = require('object-keys-normalizer');
...
},{"object-keys-normalizer":7,"qs":9}]},{},[14]);
