...
describe('currency', () => {
  ...
  describe('format', () => {
    ...
    it('should not convert amount by selected display currency when according params flag is false', async () => {
      await api.currency.select('USD');
      const formatted = api.currency.format(1, { shouldApplyConvert: false });
