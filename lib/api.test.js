...
describe('api', () => {
  ...
  describe('request', () => {
    it('should make a fetch request with auth header', async () => {
  ...
  describe('get', () => {
    ...
    it('should make a GET request with complex query string', async () => {
      ...
      expect(fetch.mock.calls.length).toEqual(1);
      expect(fetch.mock.calls[0][0]).toEqual('https://test.swell.store/api/test?one=two&foo[0][id]=1&foo[1][id]=2');
    });
  });
    ...
    describe(model, () => {
      describe('get', () => {
        ...
        it(`should make request to GET /${model} with query`, async () => {
          ...
          expect(fetch.mock.calls.length).toEqual(1);
          expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/${model}?limit=10&page=1`);
        });
        ...
        it(`should make request to GET /${model}/id?query`, async () => {
          ...
          expect(fetch.mock.calls.length).toEqual(1);
          expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/${model}/12345?query=123`);
        });
      });
    });
  });
  ...
  describe('cart', () => {
    ...
    describe('updateItems', () => {
      it('should make request to PUT /cart/items', async () => {
        await api.cart.updateItems([{ quantity: 2 }]);
    ...
    describe('removeItems', () => {
      it('should make request to DELETE /cart/items', async () => {
        await api.cart.removeItems();
  ...
  describe('account', () => {
    ...
    describe('create', () => {
      it('should make request to POST /account', async () => {
        ...
        expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/account`);
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'post');
        expect(fetch.mock.calls[0][1]).toHaveProperty('body', JSON.stringify({ name: 'Test Account' }));
      });
    });
    ...
    describe('update', () => {
      it('should make request to PUT /account', async () => {
        ...
        expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/account`);
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'put');
        expect(fetch.mock.calls[0][1]).toHaveProperty('body', JSON.stringify({ name: 'Test Update' }));
      });
    });
    ...
    describe('recover', () => {
      it('should make request to POST /account/recover', async () => {
        ...
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'post');
        expect(fetch.mock.calls[0][1]).toHaveProperty('body', JSON.stringify({ email: 'customer@example.com' }));
      });
    });
    ...
    describe('createAddress', () => {
      it('should make request to POST /account/addresses', async () => {
        ...
        expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/account/addresses`);
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'post');
        expect(fetch.mock.calls[0][1]).toHaveProperty('body', JSON.stringify({ address1: 'Test street' }));
      });
    });
    ...
    describe('deleteAddress', () => {
      it('should make request to DELETE /account/addresses/id', async () => {
        ...
        expect(fetch.mock.calls.length).toEqual(1);
        expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/account/addresses/12345`);
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'delete');
      });
    });
    ...
    describe('createCard', () => {
      it('should make request to POST /account/cards', async () => {
        ...
        expect(fetch.mock.calls[0][0]).toEqual(`https://test.swell.store/api/account/cards`);
        expect(fetch.mock.calls[0][1]).toHaveProperty('method', 'post');
        expect(fetch.mock.calls[0][1]).toHaveProperty('body', JSON.stringify({ token: 'tok_test' }));
      });
    });
